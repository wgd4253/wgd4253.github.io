...
<meta property="og:url" content="wgd4253.github.io">
<meta property="og:description" content="제목아래쪽에 한줄 나오는 짧은 소개글">
<meta property="og:image" content="img/appointment/flower-top.png">
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="css/bootstrap.min.css"> <!-- 메인 CSS -->
    <link rel="stylesheet" href="css/owl.carousel.min.111css">
    <link rel="stylesheet" href="css/magnific-popup.111css">
    <link rel="stylesheet" href="css/font-awesome.min.111css">
    <link rel="stylesheet" href="css/themify-icons.111css">
    <link rel="stylesheet" href="css/nice-select.css"> <!-- 리스트박스 --->
    <link rel="stylesheet" href="css/flaticon.111css">
    <link rel="stylesheet" href="css/flaticon.111css">
    <link rel="stylesheet" href="css/gijgo.111css">
    <link rel="stylesheet" href="css/slicknav.css"> <!-- 메뉴구성 -->
...
<body>
    ...
    <div class="attending_area">
	  <script type="text/javascript" src="asp/member.js"></script>    <!--- JavaScript 함수 링크 -->
      <form method="post" action="addOK.asp"> <!---addOK.asp 링크 -->
        <div class="container">
            <div class="row">
                                        ...
                                        <form action="#">
                                            <div class="row">
                                              ...
                                              <!--      <select class="form-select wide" id="default-select" class="">
                                                ...
                                                <div class="col-xl-12">
                                                    <textarea name="txtcomment" placeholder="Additional Message"></textarea>
                                                  </div>
												</div>
                                                <div class="col-xl-12">
                                                    <input type="button" class="boxed_btn3" onClick="Send();" value=R.S.V.P />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script>
        $('#clock').countdown('2021/11/20', function (event) {
            $(this).html(event.strftime(
                '<div class="countdown_wrap d-flex"><div  class="single_countdown"><h3>%D</h3><span>Days</span></div><div class="single_countdown"><h3>%H</h3><span>Hours</span></div><div class="single_countdown"><h3>%M</h3><span>Mins</span></div><div class="single_countdown"><h3>%S</h3><span>Seconds</span></div></div>'
            ));
        });
    </script>
    <script>
